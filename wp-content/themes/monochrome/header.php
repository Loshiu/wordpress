...
if ( $paged >= 2 || $page >= 2 ) echo ' | ' . sprintf( __( 'Page %s', 'monochrome' ), max( $paged, $page ) );
?></title>
 ...
 <div id="header">
  ...
  <div id="header_top">
   ...
   <?php if ($options['use_logo']): ?>
    <h1><a href="<?php echo bloginfo('url'); ?>/" id="logo_image"><img src="<?php bloginfo('template_url'); ?>/img/<?php echo $options['logo_name']; ?>" alt="<?php bloginfo('name'); ?>" title="<?php bloginfo('name'); ?>" /></a></h1>
   <?php else: ?>
   ...
   <div class="header_menu">
    <ul class="menu">
     <li class="<?php if (!is_paged() && is_front_page()) { ?>current_page_item<?php } else { ?>page_item<?php } ?>"><a href="<?php echo bloginfo('url'); ?>/"><?php _e('HOME','monochrome'); ?></a></li>
     <?php
